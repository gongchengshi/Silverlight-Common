...
namespace System.Windows.Controls.Primitives
{
    ...
    public class UniformGrid : Panel
    {
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            var size = new Size();
            if (constraint.Width < (maxChildDesiredWidth * ComputedColumns))
            {
                size.Width = constraint.Width;
            }
            else
            {
                size.Width = maxChildDesiredWidth * ComputedColumns;
            }
            if (constraint.Height < (maxChildDesiredHeight * ComputedRows))
            {
                size.Height = constraint.Height;
            }
            else
            {
                size.Height = (maxChildDesiredHeight * ComputedRows);
            }
            return size;
            //return constraint;
        }
